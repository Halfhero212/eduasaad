...
const translations: Record<Language, Record<string, string>> = {
  ar: {
    ...
    "toast.teacher_hard_deleted": "تم حذف المعلم نهائياً",
    "toast.teacher_hard_deleted_desc": "تمت إزالة جميع بيانات المعلم ودوراته",
    "toast.student_hard_deleted": "تم حذف الطالب نهائياً",
    "toast.student_hard_deleted_desc": "تمت إزالة جميع بيانات الطالب وسجلاته",
    ...
    "toast.quiz_response_uploaded": "تم إرسال رد المعلم",
    "toast.quiz_response_uploaded_desc": "تم إعلام الطالب بالتصحيح",
    ...
    "auth.email_or_phone_placeholder": "example@domain.com أو 07730145334",
    "auth.phone_only": "رقم الهاتف فقط",
    "auth.country_code": "مفتاح الدولة",
    "auth.identifier_required": "البريد الإلكتروني أو الهاتف مطلوب",
    "auth.invalid_identifier": "يرجى إدخال بريد إلكتروني أو رقم هاتف صالح",
    ...
    "dashboard.superadmin.archived_teachers": "المعلمون المعطَّلون",
    "dashboard.superadmin.archived_teachers_desc": "احذف الحسابات المعطلة نهائياً عند الحاجة",
    ...
    "dashboard.teacher.upload_response": "رفع الرد المصحح",
    "dashboard.teacher.upload_response_label": "حمّل الصور بعد إضافة الدرجات أو الملاحظات (بحد أقصى 5)",
    "dashboard.teacher.upload_response_missing": "يرجى اختيار الصور قبل الرفع",
    "dashboard.teacher.uploaded_response": "صور رد المعلم",
    "dashboard.teacher.quizzes_section": "الاختبارات",
    "dashboard.teacher.quizzes_section_desc": "إدارة الاختبارات وتتبع إجابات الطلاب",
    "dashboard.teacher.quiz_active": "نشط",
    "dashboard.teacher.quiz_closed": "مغلق",
    "dashboard.teacher.view_submissions": "عرض الإجابات",
    "dashboard.teacher.close_quiz": "إغلاق الاختبار",
    "dashboard.teacher.reopen_quiz": "إعادة فتح الاختبار",
    "dashboard.teacher.no_quizzes": "لم تقم بإنشاء أي اختبارات بعد.",
    "dashboard.teacher.submissions_title": "إجابات الطلاب",
    "dashboard.teacher.no_submissions": "لا توجد إجابات لهذا الاختبار بعد.",
    ...
    "dashboard.student.quiz_results": "نتائج الاختبارات",
    "dashboard.student.quiz_results_desc": "أحدث الدرجات وتعليقات المعلمين",
    "dashboard.student.no_quiz_results": "لم تقم بتسليم أي اختبار بعد",
    "dashboard.student.quiz_score": "الدرجة",
    "dashboard.student.awaiting_feedback": "بانتظار تقييم المعلم",
    "dashboard.student.teacher_response_ready": "تم رفع رد المعلم",
    "dashboard.student.quiz_feedback": "ملاحظات المعلم",
    "dashboard.student.submitted_at": "تاريخ الإرسال",
    "dashboard.student.view_lesson": "اذهب للدرس",
    ...
    "dialog.delete.teacher_message": "هل أنت متأكد من تعطيل هذا المعلم؟ سيُمنع من الدخول لكن تظل دوراته متاحة.",
    "dialog.delete.teacher_hard_warning": "للحذف النهائي سيتم إزالة جميع دوراته وبياناته نهائياً.",
    "dialog.delete.student_message": "هل أنت متأكد من تعطيل هذا الطالب؟ سيُمنع من الدخول لكن تبقى السجلات محفوظة.",
    "dialog.delete.student_hard_warning": "للحذف النهائي سيتم إزالة كل التقدم والمراجعات المرتبطة به.",
    "dialog.delete.category_message": "هل أنت متأكد من حذف هذه الفئة؟ لا يمكن حذف الفئات التي تحتوي على دورات.",
    "dialog.delete.course_message": "هل أنت متأكد من حذف هذه الدورة؟ سيتم إزالة جميع الدروس والتسجيلات المرتبطة بها.",
    "dialog.delete.confirm": "نعم، احذف",
    "dialog.delete.cancel": "إلغاء",
    "dialog.delete.deleting": "جاري الحذف...",
    "dialog.delete.teacher_success": "تم تعطيل المعلم بنجاح",
    "dialog.delete.teacher_success_desc": "تم إخفاء حساب المعلم ومنعه من الدخول",
    "dialog.delete.student_success": "تم تعطيل الطالب بنجاح",
    "dialog.delete.student_success_desc": "تم إخفاء حساب الطالب ومنعه من الدخول",
    ...
    "action.edit": "تعديل",
    "action.delete": "حذف",
    "action.delete_permanently": "حذف نهائي",
    "action.archive_account": "تعطيل الحساب",
    "action.save": "حفظ",
    "action.cancel": "إلغاء",
    "action.hide": "إخفاء",
    "action.show": "إظهار",
    ...
    "quiz.teacher_feedback": "ملاحظات المعلم",
    "quiz.teacher_images": "صور تصحيح المعلم",
    "quiz.already_submitted": "تم إرسال إجابتك لهذا الاختبار",
    "quiz.awaiting_feedback": "تم إرسال إجابتك، بانتظار رد المعلم",
    "quiz.view_image": "عرض الصورة",
  ...
  en: {
    ...
    "toast.teacher_hard_deleted": "Teacher permanently deleted",
    "toast.teacher_hard_deleted_desc": "All courses and data for this teacher have been removed",
    "toast.student_hard_deleted": "Student permanently deleted",
    "toast.student_hard_deleted_desc": "All progress and data for this student have been removed",
    ...
    "toast.quiz_response_uploaded": "Response uploaded",
    "toast.quiz_response_uploaded_desc": "Student has been notified of your feedback",
    ...
    "quiz.closed": "Quiz is closed",
    "quiz.teacher_feedback": "Teacher feedback",
    "quiz.already_submitted": "You already submitted this quiz",
    "quiz.teacher_images": "Teacher correction images",
    "quiz.awaiting_feedback": "Submission received, awaiting teacher review",
    "quiz.view_image": "View image",
    "quiz.score": "Score",
    "quiz.feedback": "Feedback",
    "quiz.confirm_delete": "Are you sure you want to delete this quiz?",
    ...
    "auth.email_placeholder": "your.email@example.com",
    "auth.email_or_phone_placeholder": "your.email@example.com or +9647730145334",
    "auth.phone_only": "Phone Number",
    "auth.country_code": "Country Code",
    "auth.identifier_required": "Email or phone number is required",
    "auth.invalid_identifier": "Please enter a valid email or phone number",
    ...
    "dashboard.superadmin.archived_teachers": "Archived Teachers",
    "dashboard.superadmin.archived_teachers_desc": "Permanently delete disabled teacher accounts",
    ...
    "dashboard.teacher.upload_response": "Upload graded response",
    "dashboard.teacher.upload_response_label": "Attach the corrected photos (max 5)",
    "dashboard.teacher.upload_response_missing": "Please select images before uploading",
    "dashboard.teacher.uploaded_response": "Uploaded teacher response",
    "dashboard.teacher.quizzes_section": "Quizzes",
    "dashboard.teacher.quizzes_section_desc": "Manage quizzes and review student submissions",
    "dashboard.teacher.quiz_active": "Active",
    "dashboard.teacher.quiz_closed": "Closed",
    "dashboard.teacher.view_submissions": "View submissions",
    "dashboard.teacher.close_quiz": "Close quiz",
    "dashboard.teacher.reopen_quiz": "Reopen quiz",
    "dashboard.teacher.no_quizzes": "You haven't created any quizzes yet.",
    "dashboard.teacher.submissions_title": "Student submissions",
    "dashboard.teacher.no_submissions": "No submissions for this quiz yet.",
    ...
    "dashboard.student.quiz_results": "Quiz results",
    "dashboard.student.quiz_results_desc": "Latest grades and teacher feedback",
    "dashboard.student.no_quiz_results": "You haven't submitted any quizzes yet",
    "dashboard.student.quiz_score": "Score",
    "dashboard.student.awaiting_feedback": "Awaiting teacher review",
    "dashboard.student.teacher_response_ready": "Teacher response available",
    "dashboard.student.quiz_feedback": "Teacher feedback",
    "dashboard.student.submitted_at": "Submitted at",
    "dashboard.student.view_lesson": "Go to lesson",
    ...
    "dialog.delete.teacher_message": "Are you sure you want to disable this teacher? They will no longer be able to sign in.",
    "dialog.delete.teacher_hard_warning": "Permanent delete will remove all courses and data associated with this teacher.",
    "dialog.delete.student_message": "Are you sure you want to disable this student? They will no longer be able to sign in.",
    "dialog.delete.student_hard_warning": "Permanent delete will remove all progress, enrollments, and reviews for this student.",
    ...
    "dialog.delete.course_message": "Are you sure you want to delete this course? All lessons and enrollments will also be removed.",
    "dialog.delete.confirm": "Yes, Delete",
    "dialog.delete.cancel": "Cancel",
    "dialog.delete.deleting": "Deleting...",
    "dialog.delete.teacher_success": "Teacher archived successfully",
    "dialog.delete.teacher_success_desc": "The teacher can no longer sign in, but their courses remain",
    "dialog.delete.student_success": "Student archived successfully",
    "dialog.delete.student_success_desc": "The student can no longer sign in and stays hidden",
    ...
    "action.archive_account": "Archive Account",
    "action.save": "Save",
