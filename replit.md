...
- **Q&A System**: Students can ask questions on specific video lessons, and only the course teacher can reply, forming threaded discussions. **Privacy-focused**: Each student sees only their own questions and teacher replies to them, not other students' questions. Teachers and superadmins see all questions to facilitate comprehensive support. Teachers can click "Reply" button on any student question to post answers, which are displayed indented under the parent question.
